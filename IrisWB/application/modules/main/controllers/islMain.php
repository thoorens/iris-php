 ...
 * It is a test class for Islets (type : found in main module)
 * 
 */
class islMain extends \Iris\MVC\_Islet{
    
    /**
     *
     * @param string $text A message received from outside
     * 
     * WARNING : action parameters in islets should have a default value. Here
     * it has none to permit error testing 
     */
